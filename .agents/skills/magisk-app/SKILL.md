---
name: magisk-app
description: Guidelines, architecture, development conventions, and build workflows for the Magisk Android application (app/ subproject). Use when working on, modifying, building, or testing code in app/ or any of its submodules (:core, :apk, :shared, :stub, :stub-res, :build-logic, :apk-legacy).
---
...
- **`:core`** (`core/`): Core domain logic, resources, configuration databases, and services. Primary target for core feature development.
...
- **Data Stack:** Wire (Protocol Buffers), Moshi, and the native configuration database interface.
